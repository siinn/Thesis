...
%\hypersetup{colorlinks=true,linkcolor=blue, breaklinks} %internal links in blue, citations in green: ORIGINAL
...
\include{latex/acronyms} %load list of acronyms contained in acronyms.tex
