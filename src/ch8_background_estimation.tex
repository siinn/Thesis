...
The vertex yields from the TF and EM method, which represent the estimation for the random-crossing background, are compared with the actual vertex yields in Table~\ref{table:random_vertex_count}. No random-crossing background of \mumu, \ee, or \emu type is expected from the MC samples using both methods. 
...
\begin{table}[!htb]%
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}[t]{ccccc}
        \hline\hline
                                  & Est. (EM)    & Raw est. from xx (TF) & Raw est. from $\mu$x, $e$x (TF) & Corrected est. (TF) \\
         \hline                                         
         $N_{\mu\mu}$             & $1.43\times10^{-3}$  & $2.69\times10^{-3}$  & $2.19\times10^{-3}$            & $1.79\times10^{-3}$ \\
         $N_{ee}$                 & $2.70\times10^{-4}$  & $5.56\times10^{-3}$  & $1.05\times10^{-3}$            & $1.99\times10^{-4}$ \\
         $N_{e\mu}$               & $7.00\times10^{-4}$  & $7.73\times10^{-3}$  & $3.89\times10^{-3}$            & $1.96\times10^{-3}$ \\
         \hline                                         
         Sum                      & $2.40\times10^{-3}$ & $1.60\times10^{-2}$  & $7.13\times10^{-3}$            & $3.95\times10^{-3}$ \\
        \hline\hline
    \end{tabular}
  }
