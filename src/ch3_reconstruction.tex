...
\begin{figure}[!htb]
    ...
    \centering
    \caption{Illustration of detector hits and reconstructed tracks in the ID. The bright colors represent the detector hits associated with reconstructed tracks~\cite{Cornelissen:1176900}.}
    \caption{}
    \label{fig:tracking}
\end{figure}
