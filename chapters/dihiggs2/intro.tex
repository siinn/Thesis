...
\begin{figure}[!h] 
\begin{center}
\includegraphics*[width=0.35\textwidth] {figures/standardModel/BSM-dihiggs-prod_W}
...
% In order to reduce the backgrounds to allow a
%simple counting experiment a likelihood method was used to
%dramatically reduce the backgrounds.
