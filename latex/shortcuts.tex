...
% vertex probability
\newcommand*{\Pxx}{\ensuremath{P_{(\mathrm{xx})}           }\xspace}
\newcommand*{\Pmx}{\ensuremath{P_{(\mu \mathrm{x})}        }\xspace}
\newcommand*{\Pex}{\ensuremath{P_{(e \mathrm{x})}          }\xspace}
\newcommand*{\Pee}{\ensuremath{P_{(ee)}                    }\xspace}
\newcommand*{\Pmm}{\ensuremath{P_{(\mu\mu)}                }\xspace}
\newcommand*{\Pem}{\ensuremath{P_{(e\mu)}                  }\xspace}
